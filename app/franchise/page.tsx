    ...
    <SiteShell active="partners">
      ...
      <section className="partner-faq">
        ...
        <div className="question-list">
          <details data-reveal><summary>What does a KH franchise actually give me?<span>+</span></summary><p>The right to sell KH-represented international brands in your territory, supplied from KH stocked yards, under agreed pricing and brand standards&mdash;with the KH name behind your business.</p></details>
          ...
          <details data-reveal><summary>What does it cost to join?<span>+</span></summary><p>Terms depend on territory and scale, and are agreed openly during the assessment stage&mdash;no hidden structures.</p></details>
          <details data-reveal><summary>I&apos;m a manufacturer, not a trader. Where do I go?<span>+</span></summary><p>Our partnerships page covers agency, distribution, and market entry for international manufacturers&mdash;<Link href="/partners">explore partnerships</Link>.</p></details>
        </div>
      </section>
