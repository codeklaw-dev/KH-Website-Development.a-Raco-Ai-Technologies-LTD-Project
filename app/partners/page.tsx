...
import { KhMonogram } from "../components/KhMonogram";
    ...
    <SiteShell active="partners">
      ...
      */}
      ...
      <section className="partner-advantage">
        <div className="advantage-heading" data-reveal="left"><KhMonogram className="advantage-monogram" /><p className="eyebrow">Why KH Wood</p><h2>A partner who can<br /><em>carry the detail.</em></h2></div>
