    ...
    <SiteShell active="company">
      ...
      */}
      ...
      <section className="heritage-film" aria-label="KH Wood heritage film">
        <video autoPlay muted loop playsInline preload="metadata" poster="/assets/kh-concept-poster-6e9dbb18.jpg"><source media="(max-width: 820px)" src="/assets/kh-concept-mobile-bc4de27e.mp4" type="video/mp4" /><source src="/assets/kh-concept.mp4" type="video/mp4" /></video>
        <div className="heritage-film-shade" />
        <div className="heritage-film-copy" data-reveal="up"><span>Material in motion · KH heritage</span><h2>Handled by people.<br /><em>Carried by relationships.</em></h2><p>Wood has always moved through hands, places, and generations. That continuity still shapes how KH Wood does business.</p></div>
      </section>
      ...
      <section className="sector-field" id="sectors">
        ...
        <div className="sector-mosaic">
          ...
          <article className="sector-text" data-reveal="right"><span>Public procurement</span><h3>Structured supply for institutional requirements.</h3><p>Full documentation and supply continuity for tender-driven work.</p></article>
        </div>
      </section>
      ...
      <section className="company-commitment">
        ...
        <div className="commitment-copy" data-reveal="right"><p className="eyebrow">A long-term operating standard</p><h2>Reputation is built<br /><em>shipment by shipment.</em></h2><p>The Khodeer name is attached to every commercial relationship. One expectation follows: be clear about what is possible, stay accountable to the agreed process, and build business that lasts.</p><div className="commitment-points"><span>Direct senior involvement</span><span>Commercial transparency</span><span>Respect for local context</span><span>Long-term partner thinking</span></div><Link className="button button-red" href="/contact">Speak with KH Wood <b>↗︎</b></Link></div>
      </section>
    </SiteShell>
  );
}
